...
public static class MarketTests {
  ...
  public static void Market_Created_WithBoundedState() {
    ...
    var market = new Market(new MarketId(Guid.Parse("00000000-0000-7000-8000-000000000001")), new MarketName("Market"), Image);

    Assert.Equal(new MarketId(Guid.Parse("00000000-0000-7000-8000-000000000001")), market.Id);
